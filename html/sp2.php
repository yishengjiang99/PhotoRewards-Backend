...
if($_GET['pw']=="dafhfadsfkdsadlds") $network='ragnus';
...
$offer=db::row("select cash_value from offers where storeID=$appid");
...
db::exec("insert ignore into sponsored_app_installs set uid=$uid, Amount=$points, appid=$appid, created=now(),offer_id=$offerId, subid='$subid'");
$installid=db::lastID();
