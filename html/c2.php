...
$newuser=0;
var_dump("select * from appuser where app='$cb' and mac='$mac'");
if(!$user){
  $newuser=1;
...
if($cb=="picrewardsdev" || $cb=="picrewards"){
 if($newuser==1){
 $tapjump="http://sa.jumptap.com/a/conversion?idfa=$idfa&mac_sha1=&app=com.ragnus.PictureRewards&event=Download&eventId=4045&amount=&currency=&units=1";
