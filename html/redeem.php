...
error_log("$uid redeemed $rid out of stuck");
 ...
 if($email!='' && $rid==11){
   ...
   $msg="go to https://starbucks.cashstar.com/gift-card/view/$urlcode/ and enter the secret code $serect";
   error_log("insert into inbox set from_uid=2902, to_uid=$uid, msg='$msg', reply_to=0, created=now()");
 }
