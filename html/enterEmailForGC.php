...
<p>Please enter your email address to redeem <?= $reward['Points'] ?> Points for an $<?php echo $reward['CashValue'] ?> <?php echo $reward['name'] ?></p>
