...
if(true){
 ...
 $d = array('offer_types'=>'102,106,112,113', 'appid' => "18101", 'apple_idfa'=>$idfa, 'apple_idfa_tracking_enabled'=>'true','timestamp'=>time(), 'ip' => getRealIP(), 'locale' => 'en', 'page' => $page, 'uid' => $uid);
 ksort($d);
 $params = '';
 foreach($d as $k=>$v)
 {
