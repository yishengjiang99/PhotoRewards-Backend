...
if(false && $ltv>450 && $country!="VN" && $locale!="" && $locale!="vi_VN" && $user['banned']!=1 && $start==20){
...
if($ltv>1 && $start<20){
  ...
  $url="https://m.appdog.com/m_iphone/?exchange=300&currency=Points&affsource=9135311512939222220&idfa=$idfa&fbid=$uid&hash=$hash";
