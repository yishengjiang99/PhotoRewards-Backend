...
//   if($country!="US" || in_array($user['locale'],array("","en_GB","es_LA","it_IT","vi_VN"))) $payoutToUser=$payoutToUser/3000;
   $name=$_GET['name'];
   $storeID=999;
   $s2=$name;
...
//  if($user['fbid']==0 || $user['fbfriends']<3 || $user['country']=="GB" || in_array($user['locale'],array("vi_VN","en_GB","es_LA","it_IT","vi_VN"))) $payoutToUser=$payoutToUser/3;	
