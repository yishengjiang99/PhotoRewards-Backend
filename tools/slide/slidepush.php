...
stream_context_set_option($ctx, 'ssl', 'local_cert', 'slidProdCertKey2.pem');
...
$sql="select a.token,xp from pushtokens a join appuser b on a.mac_address=b.mac where b.app='slide' order by xp desc";
$rank=0;
$rows=db::rows($sql);
foreach($rows as $row){
...
$message="Solve 1 puzzle to find out how to get a FREE Amazon Gift Card";
echo "\n$message";
 $body['aps'] = array(
	'alert' => $message,
	'sound' => 'default',
